                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-10 border-b border-white/10 pb-12">
                    ...
                    <div className="col-span-1 md:col-span-1">
                        ...
                        <div className="flex gap-4">
                            ...
                            <a href="https://t.me/saagronigltd" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/5 rounded-full hover:bg-agro-green transition-all hover:-translate-y-1"><Send size={20} /></a>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li className="flex items-center gap-3">
                                ...
                                <span className="text-gray-400">info@saagro.com.ng</span>
                            </li>
                            <li className="flex items-center gap-3">
                                <Mail className="text-agro-grain shrink-0" size={20} />
